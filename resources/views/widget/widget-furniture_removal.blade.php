<div class="ai-tool-right-top top-menu-bar-first">
    <ul class="progress-bar-tab">
        ...
        <li class="second_tab_active">
            <div class="ai-tool-right-steps"></div>
            <span>{{ trans('content.select_elements_to_remove') }}</span>
        </li>
    </ul>
</div>
            ...
            <div class="gs-what-to-edit-tips">
                <div class="gs-what-to-edit-tip-box">
                    <div class="gs-what-to-edit-tip-right">
                        <p>{{ trans('content.right_tip_furniture_removal_first') }}</p>
                    </div>
                </div>
                <div class="gs-what-to-edit-tip-box">
                    <div class="gs-what-to-edit-tip-right">
                        <p>{{ trans('content.right_tip_furniture_removal_second') }}</p>
                    </div>
                </div>
                <div class="gs-what-to-edit-tip-box">
                    <div class="gs-what-to-edit-tip-right">
                        <p>{{ trans('content.right_tip_furniture_removal_third') }}</p>
                    </div>
                </div>
            </div>
        </div>
