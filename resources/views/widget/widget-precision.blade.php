    ...
    <div class="image-show-container image-mask-container">
        <div class="gs-what-to-edit-wrapper">
                            ...
                            <div id="refine-manually-precision" class="tab-pane show fade">
                                <div class="gs-select-manually-inner">
                                    <div class="gs-select-manually-top">
                                        ...
                                        <input type="hidden" value="70" id="ip-brush-thickness-inPaint" />
                                        <input class="gs-select-manually-value" type="text" id="amount-inPaint" value="70"
                                            readonly="">
                                    </div>
            ...
            <div class="gs-what-to-edit-right category-container" style="display: none">
                ...
                <div class="tab-content">
                    <div id="interior-inpaint1" class="tab-pane fade in hide_int">
                        <div class="gs-what-to-edit-tabs">
                            <div class="gs-what-to-edit-title">
                                <ul>
                                    <li class="active"><a data-toggle="tab"
                                            href="#our-preset-settings-interior-inPaint">Our
                                            preset settings</a></li>
                                    <li><a data-toggle="tab" href="#your-customs-settings-interior-inPaint">Your
                                            customs
                                            settings </a></li>
                                </ul>
                            </div>
                            <div class="gs-what-to-edit-content">
                                <div class="tab-content">
                                    <div id="our-preset-settings-interior-inPaint"
                                        ...
                                        <div class="gs-select-automatically">
                                            ...
                                            <div class="gs-our-preset-settings ">
                                                ...
                                                <div class="gs-select-room-style">
                                                    ...
                                                    <div class="gs-select-room-style-row"
                                                        id="designStyleDisplay0-inPaint">
                                                        <div class="gs-select-room-style-single"
                    ...
                    <div id="exterior-inpaint1" class="tab-pane fade hide_ext">
                        <div class="gs-what-to-edit-tabs">
                            <div class="gs-what-to-edit-title">
                                <ul>
                                    <li class="active"><a data-toggle="tab"
                                            href="#our-preset-settings-exterior-inpaint1">Our
                                            preset settings</a></li>
                                    <li><a data-toggle="tab" href="#your-customs-settings-exterior-inpaint1">Your
                                            customs
                                            settings </a></li>
                                </ul>
                            </div>
                            <div class="gs-what-to-edit-content">
                                <div class="tab-content">
                                    <div id="our-preset-settings-exterior-inpaint1"
                                        class="tab-pane show fade in active">
                                        <div class="gs-select-automatically">
                                            {{-- <p>You can change the colors only, or also change textures, materials.</p> --}}
                                            <div class="gs-our-preset-settings ">
                                                ...
                                                <div class="gs-select-room-style">
                                                    ...
                                                    <div class="gs-select-room-style-row"
                                                        id="designStyleDisplay1-inPaint">
                                                        <div class="gs-select-room-style-single"
                    ...
                    <div id="garden-inpaint1" class="tab-pane fade hide_gar">
                        <div class="gs-what-to-edit-tabs">
                            <div class="gs-what-to-edit-title">
                                <ul>
                                    <li class="active"><a data-toggle="tab"
                                            href="#our-preset-settings-garden-inpaint1">Our
                                            preset settings</a></li>
                                    <li><a data-toggle="tab" href="#your-customs-settings-garden-inpaint1">Your
                                            customs
                                            settings </a></li>
                                </ul>
                            </div>
                            <div class="gs-what-to-edit-content">
                                <div class="tab-content">
                                    <div id="our-preset-settings-garden-inpaint1"
                                        class="tab-pane show fade in active">
                                        <div class="gs-select-automatically">
                                            {{-- <p>You can change the colors only, or also change textures, materials.</p> --}}
                                            <div class="gs-our-preset-settings ">
                                                ...
                                                <div class="gs-select-room-style">
                                                    ...
                                                    <div class="gs-select-room-style-row"
                                                        id="designStyleDisplay2-inPaint">
                                                        <div class="gs-select-room-style-single"
                                                            data-design-style="Modern"
