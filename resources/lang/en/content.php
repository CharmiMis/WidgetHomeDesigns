...
return [
        'redesign' => 'Redesign',
        'precision' => 'Precision+',
        'fill_spaces' => 'Fill Spaces',
        'decor_staging' => 'Decor Staging',
        'colors_and_textures' => 'Colors & Textures',
        'paint_visualizer' => 'Paint Visualizer',
        'furniture_removal' => 'Furniture Removal',
        'virtual_staging' => 'Virtual Staging',
        'sky_colors' => 'Sky Colors',
        ...
        'design_style_text' => 'Design Style',
        ...
        'intervention_very_low' => 'Very Low',
        'intervention_low' => 'Low',
        'intervention_medium' => 'Medium',
        'intervention_extreme' => 'Extreme',
        'generate_new_designs' => 'Generate New Designs',
        'preset_prompt_text' => 'Type your custom instructions below and our AI will take them into account when generating your designs:',
        'custom_inst_placeholder' => 'e.g. A clean-looking living room with black and yellow textures and a coffee table made from hardwood.',
        'custom_inst_placeholder_pricion' => 'e.g. Scandinavian dining room design, beautiful, white colors',
        'our_preset_settings' => 'Our preset settings',
        'your_custom_settings' => 'Your Custom settings',
        'select_house_angle' => 'Select House Angle',
        ...
        'latest_designs_info' => 'Check your latest designs below and save them to projects or to favorites.',
        'select_garden_type' => 'Select Garden Type',
        'view_all' => 'View All',
        'change_weather' => 'Change Weather',
        'change_sky_colors' => 'Change Sky Colors to:',
        'sunshine' => 'Sunshine',
        'rainy' => 'Rainy',
        'cloudy' => 'Cloudy',
        'clear_sky' => 'Clear Sky',
        ...
        'select_manually_text' => 'Select objects automatically',
        'select_manually_content' => 'Automatically or manually select objects, with the ability to combine both
                                        methods.',
        'continue_text' => 'Continue',
        'brush_edit_manually_content' => 'Edit manually using the brush',
        'remove_masking' => 'Remove Masking',
        'add_masking' => 'Add Masking',
        'circle_brush' => 'Circle Brush',
        'square_brush' => 'Square Brush',
        'clear_all' => 'Clear all',
        'ai_strength' => 'AI Strength',
        'standard_paints' => 'Standard Paints',
        'custom_paints' => 'Custom Paints',
        'custom_color_image' => 'Custom Color Image',
        'color_list_text' => 'Select a paint color from the list:',
        'color_picker_text' => 'Click to open color picker :',
        'color_picker_placeholder' => 'No Color Selected',
        'upload_paint_sample' => 'Upload sample of paint(.jpeg, .png)',
        'select_elements_to_remove' => 'Select elements to remove',
        'preset_colors' => 'Preset Colors',
        'custom_colors' => 'Custom Colors',
        'what_change_text' => 'What do you want to change?',
        'color' => 'Color',
        'material' => 'Material',
        'color_Selection_text' => 'Select a color from the list:',
        'texture_Selection_text' => 'Pick a texture from the list:',
        'fabrics' => 'Fabrics',
        'glass' => 'Glass',
        'wood' => 'Wood',
        'stone' => 'Stone',
        ...
        'select_exterior_materials' => 'Select Exterior Materials',
        'facade' => 'Facade',
        'roofing' => 'Roofing',
        'decking_and_walkways' => 'Decking and Walkways',
        'outdoor_fixtures_and_accents' => 'Outdoor Fixtures and Accents',
